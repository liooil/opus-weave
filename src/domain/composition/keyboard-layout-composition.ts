import { MappingEngine, type PlayableComputerLayoutId } from '../devices/mapping-engine.ts'
import { pitchesToOwt } from './musical-typing.ts'

const TRACK_NAMES: Record<PlayableComputerLayoutId, string> = {
...
export function keyboardLayoutTextPitches(text: string, layout: PlayableComputerLayoutId): number[] {
...
export function keyboardLayoutTextToOwt(text: string, layout: PlayableComputerLayoutId): string {
