...
describe('score view models', () => {
  ...
  test('renders staff SVG and Jianpu HTML from the same model', () => {
    ...
    expect(staff).toContain('x1="0" y1="40" x2="220"')
    expect(staff).toContain('𝄞')
    expect(staff).toContain('class="staff-event" data-owt-event="0:0"')
    expect(jianpu).toContain('jianpu-measure')
    expect(jianpu).toContain('class="jianpu-event" data-owt-event="0:0"')
